...
class _HomeScreenState extends State<HomeScreen> {
  // Variabel state untuk mengontrol tampilan semua bank
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // Header Section Baru (Menggantikan AppBar)
            _buildHeaderSection(),

            // KARTU BANK (DIPERTAHANKAN SEPERTI SEMULA)
            _showAllBanks ? _buildAllBanks() : _buildSingleBankAndButton(),

            // Menu Grid (DIPERTAHANKAN SEPERTI SEMULA)
  ...
  // Widget untuk menampilkan satu bank (BCA) dan tombol "Lihat semua bank" (DIPERTAHANKAN)
  Widget _buildSingleBankAndButton() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        // Kartu Bank BCA (hanya satu) - DIPERTAHANKAN
        const AtmCard(
          bankName: 'Bank BCA',
          cardNumber: '**** 9012',
          balance: 2500000,
        ...
        // Tombol "Lihat semua bank" - DIPERTAHANKAN
        Padding(
  ...
  // Widget untuk menampilkan semua bank (DIPERTAHANKAN)
  Widget _buildAllBanks() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        // Kartu Bank BCA - DIPERTAHANKAN
        const AtmCard(
          bankName: 'Bank BCA',
          cardNumber: '**** 9012',
          balance: 2500000,
        ...
        // Kartu Bank Mandiri - DIPERTAHANKAN
        const AtmCard(
        ...
        // Tombol "Sembunyikan" - DIPERTAHANKAN
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 20.0, vertical: 5.0),
          child: TextButton(
            onPressed: () {
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              _buildNavItem(Icons.qr_code_scanner, 'QRIS', false),
